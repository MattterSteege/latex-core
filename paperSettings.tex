...
\def\institutionName    {} % replace with actual institution name
\def\institutionCountry {} % replace with actual institution location
\def\institutionCity    {} % replace with actual institution location
...
\captionsetup[figure]{
    name=Figure,                 % rename "Figure" to "Figuur"
